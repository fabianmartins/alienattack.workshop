...
export declare class Errors {
     ...
     */
    static readonly TaskFailed = "States.TaskFailed";
    /**
     ...
     */
    static readonly ResultPathMatchFailure = "States.ResultPathMatchFailure";
    /**
     * A branch of a Parallel state failed.
     */
    static readonly BranchFailed = "States.BranchFailed";
    /**
     * A Choice state failed to find a match for the condition field extracted
     * from its input.
     */
    static readonly NoChoiceMatched = "States.NoChoiceMatched";
}
/**
 * Retry details
 */

 ...
 */
export declare abstract class PipelineCloudFormationAction extends codepipeline.Action {
    /**
 ...
 */
export declare class PipelineExecuteChangeSetAction extends PipelineCloudFormationAction {
 ...
 */
export declare class PipelineCreateReplaceChangeSetAction extends PipelineCloudFormationDeployAction {
 ...
 */
export declare class PipelineCreateUpdateStackAction extends PipelineCloudFormationDeployAction {
    private readonly props2;
 ...
 */
export declare class PipelineDeleteStackAction extends PipelineCloudFormationDeployAction {
    private readonly props2;

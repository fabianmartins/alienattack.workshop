...
declare const _default: {
    ...
    'construct.node.stack returns the correct stack'(test: Test): void;
    'construct.node.stack throws when there is no parent Stack'(test: Test): void;
    'construct.node.stack.formatArn forwards to the Stack'(test: Test): void;
    'construct.node.stack.parseArn forwards to the Stack'(test: Test): void;

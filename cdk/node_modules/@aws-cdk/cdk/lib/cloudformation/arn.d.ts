 ...
 * can be 'undefined'.
 */
export declare function arnFromComponents(components: ArnComponents, stack: Stack): string;
/**
 ...
 *      components of the ARN.
 */
export declare function parseArn(arn: string, sepIfToken?: string, hasName?: boolean): ArnComponents;

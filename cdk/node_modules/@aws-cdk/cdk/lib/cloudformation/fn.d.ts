...
export declare class Fn {
     ...
     */
    static conditionAnd(...conditions: IConditionExpression[]): IConditionExpression;
    /**
     ...
     * @returns an FnCondition token
     */
    static conditionEquals(lhs: any, rhs: any): IConditionExpression;
    /**
     ...
     * @returns an FnCondition token
     */
    static conditionIf(conditionId: string, valueIfTrue: any, valueIfFalse: any): IConditionExpression;
    /**
     ...
     * @returns an FnCondition token
     */
    static conditionNot(condition: IConditionExpression): IConditionExpression;
    /**
     ...
     * @returns an FnCondition token
     */
    static conditionOr(...conditions: IConditionExpression[]): IConditionExpression;
    /**
     ...
     * @returns an FnCondition token
     */
    static conditionContains(listOfStrings: string[], value: string): IConditionExpression;
    /**
     ...
     * @returns an FnCondition token
     */
    conditionEachMemberEquals(listOfStrings: string[], value: string): IConditionExpression;
    /**
     ...
     * @returns an FnCondition token
     */
    conditionEachMemberIn(stringsToCheck: string[], stringsToMatch: string): IConditionExpression;
    /**
     ...
     * @returns a token represented as a string array
     */
    refAll(parameterType: string): string[];
    /**
     ...
     * @returns a token represented as a string
     */
    valueOf(parameterOrLogicalId: string, attribute: string): string;
    /**
     ...
     * @returns a token represented as a string array
     */
    valueOfAll(parameterType: string, attribute: string): string[];
}
